...
public class OrderModuleRap2Generator {
    ...
    public void queryOrder() throws Exception {
        ParseConfig parseConfig = ParseConfigJsonUtil.parseByJsonFile("订单/订单模块/订单查询.json");
    ...
    public void saveOrder() throws Exception {
        ParseConfig parseConfig = ParseConfigJsonUtil.parseByJsonFile("订单/订单模块/新建订单.json");
        Rap2Generator rap2Generator = new Rap2Generator();
        rap2Generator.setParseConfig(parseConfig);
        rap2Generator.generate();
    }
